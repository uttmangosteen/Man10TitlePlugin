    ...
    public boolean onCommand(@NotNull CommandSender sender, org.bukkit.command.@NotNull Command command, @NotNull String alias, String[] args) {
        ...
        for (int i = 0, j = 0; i < args.length; i++) {
            ...
            switch (j) {
                ...
                case 2: try {stay = Integer.parseInt(args[i]);} catch (NumberFormatException ignored) {}continue;
                case 3: try {fadeIn = Integer.parseInt(args[i]);} catch (NumberFormatException ignored) {}continue;
                case 4: try {fadeOut = Integer.parseInt(args[i]);} catch (NumberFormatException ignored) {}
                default: break;
            }
        }
